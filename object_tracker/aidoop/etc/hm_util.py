...
if __name__ == "__main__":
    ...
    print("XYZABC --> HM")
    hmcal = HMUtil.convert_xyzabc_to_hm_by_deg(xyzabc)
    print("Converted HM")
    print(hmcal)
    print()
    ...
    xyzabc_calc = HMUtil.convert_hm_to_xyzabc_by_deg(hmcal)
    print(xyzabc_calc)
    print()

    # 3. test inverse_homogeneous_matrix
    ...
    print(
        np.dot(
            hmpinv,
            np.array(
                [-0.09064515960284498, -0.6685702677827611, 0.07567205103501873, 1],
                dtype=np.float64,
            ).T,
        )
    )
    ...
    hminv = HMUtil.inverse_homogeneous_matrix(hm)
