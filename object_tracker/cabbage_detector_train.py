...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 box_detector_train.py train --dataset=/path/to/object/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 box_detector_train.py train --dataset=/path/to/object/dataset --weights=last
...
class TrainConfig(Config):
    ...
    BACKBONE = (
        "resnet101"  # "resnet101" or "resnet50"      # TODO: configurable parameter
    )
...
class SingleObjectDataSet(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        """
        # If not a cbg dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "cbg":
